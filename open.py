...
for BasicInfo in Curri_Vitae:
        ...
        Resume.cell(250.5,10, f"{BasicInfo['Name']}", align= 'C', ln=True)
        Resume.set_font('times', '', 12)
        Resume.cell(290,5, f"Permanent Address: {BasicInfo['Permanent Address']}", align= 'C', ln=1)
        Resume.set_font('times', '', 12)
        Resume.cell(230,9, f"{BasicInfo['Phone Number']}", align= 'C', ln=True)
        Resume.set_font('times', '', 12)
        Resume.cell(280,5, f"Email: {BasicInfo['Email']}", align= 'C', ln=1)
        Resume.set_font('times', '', 12)
        Resume.cell(66.7,9, f"Birthdate: {BasicInfo['Birthdate']}", align= 'C', ln=1)
        Resume.ln (5)
        Resume.line(-1, 48, 10000, 0)
